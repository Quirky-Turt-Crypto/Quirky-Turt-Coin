...
#include "qt/quirkyturt/forms/ui_topbar.h"
#include "qt/quirkyturt/lockunlock.h"
#include "qt/quirkyturt/qtutils.h"
#include "qt/quirkyturt/receivedialog.h"
#include "qt/quirkyturt/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/quirkyturt/balancebubble.h"
...
TopBar::TopBar(quirkyturtGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("quirkyturt")
    updateDisplayUnit();
