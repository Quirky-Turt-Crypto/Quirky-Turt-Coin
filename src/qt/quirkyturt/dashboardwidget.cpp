...
#include "qt/quirkyturt/dashboardwidget.h"
#include "qt/quirkyturt/forms/ui_dashboardwidget.h"
#include "qt/quirkyturt/sendconfirmdialog.h"
#include "qt/quirkyturt/txrow.h"
...
DashboardWidget::DashboardWidget(quirkyturtGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &quirkyturtGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
