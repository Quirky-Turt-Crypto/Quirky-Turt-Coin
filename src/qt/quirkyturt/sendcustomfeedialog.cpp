...
#include "qt/quirkyturt/sendcustomfeedialog.h"
#include "qt/quirkyturt/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(quirkyturtGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &quirkyturtGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
