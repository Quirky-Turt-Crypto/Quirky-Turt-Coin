...
#include "qt/quirkyturt/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/quirkyturt/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(quirkyturtGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to quirkyturtGUI::handleRestart()
