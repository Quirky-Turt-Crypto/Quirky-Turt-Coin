...
#include "qt/quirkyturt/settings/settingsbackupwallet.h"
#include "qt/quirkyturt/settings/settingsexportcsv.h"
#include "qt/quirkyturt/settings/settingsbittoolwidget.h"
#include "qt/quirkyturt/settings/settingssignmessagewidgets.h"
#include "qt/quirkyturt/settings/settingswalletrepairwidget.h"
#include "qt/quirkyturt/settings/settingswalletoptionswidget.h"
#include "qt/quirkyturt/settings/settingsmainoptionswidget.h"
#include "qt/quirkyturt/settings/settingsdisplayoptionswidget.h"
#include "qt/quirkyturt/settings/settingsinformationwidget.h"
#include "qt/quirkyturt/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(quirkyturtGUI* parent);
    ~SettingsWidget();
