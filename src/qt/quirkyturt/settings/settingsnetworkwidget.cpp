...
#include "qt/quirkyturt/settings/settingsnetworkwidget.h"
#include "qt/quirkyturt/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/quirkyturt/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(quirkyturtGUI* _window, QWidget *parent) :
