...
#include "qt/quirkyturt/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/quirkyturt/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(quirkyturtGUI* _window, QWidget *parent) :
