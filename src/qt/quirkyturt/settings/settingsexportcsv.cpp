...
#include "qt/quirkyturt/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(quirkyturtGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("quirkyturt_tx_csv_export(*.csv)") : tr("quirkyturt_addresses_csv_export(*.csv)"),
                                        nullptr);
