...
#include "qt/quirkyturt/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(quirkyturtGUI* _window, QWidget *parent) :
