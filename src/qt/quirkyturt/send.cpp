...
#include "qt/quirkyturt/send.h"
#include "qt/quirkyturt/forms/ui_send.h"
#include "qt/quirkyturt/addnewcontactdialog.h"
#include "qt/quirkyturt/qtutils.h"
#include "qt/quirkyturt/sendchangeaddressdialog.h"
#include "qt/quirkyturt/optionbutton.h"
#include "qt/quirkyturt/sendconfirmdialog.h"
#include "qt/quirkyturt/guitransactionsutils.h"
...
SendWidget::SendWidget(quirkyturtGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    coinIcon(new QPushButton())
{
    ...
    ui->btnUri->setSubTitleClassAndText("text-subtitle", tr("Parse a quirkyturt URI"));
