...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(QRTC);
    unitlist.append(mQRTC);
    unitlist.append(uQRTC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit, bool isZqrtc)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZQRTC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZQRTC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZQRTC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZQRTC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
