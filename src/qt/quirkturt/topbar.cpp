...
#include "qt/quirkturt/forms/ui_topbar.h"
#include "qt/quirkturt/lockunlock.h"
#include "qt/quirkturt/qtutils.h"
#include "qt/quirkturt/receivedialog.h"
#include "qt/quirkturt/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/quirkturt/balancebubble.h"
...
TopBar::TopBar(quirkturtGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("quirkturt")
    updateDisplayUnit();
