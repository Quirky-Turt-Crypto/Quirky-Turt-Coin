...
#include "qt/quirkturt/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(quirkturtGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &quirkturtGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
