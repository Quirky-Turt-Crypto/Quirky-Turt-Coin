...
#include "qt/quirkturt/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/quirkturt/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(quirkturtGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to quirkturtGUI::handleRestart()
