...
#include <QWidget>
#include "qt/quirkturt/pwidget.h"
#include "qt/quirkturt/settings/settingsbackupwallet.h"
#include "qt/quirkturt/settings/settingsexportcsv.h"
#include "qt/quirkturt/settings/settingsbittoolwidget.h"
#include "qt/quirkturt/settings/settingssignmessagewidgets.h"
#include "qt/quirkturt/settings/settingswalletrepairwidget.h"
#include "qt/quirkturt/settings/settingswalletoptionswidget.h"
#include "qt/quirkturt/settings/settingsmainoptionswidget.h"
#include "qt/quirkturt/settings/settingsdisplayoptionswidget.h"
#include "qt/quirkturt/settings/settingsinformationwidget.h"
#include "qt/quirkturt/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(quirkturtGUI* parent);
    ~SettingsWidget();
