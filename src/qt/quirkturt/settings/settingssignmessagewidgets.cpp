...
#include "qt/quirkturt/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(quirkturtGUI* _window, QWidget *parent) :
