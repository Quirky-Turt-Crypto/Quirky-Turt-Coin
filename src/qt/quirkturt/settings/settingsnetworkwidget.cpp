...
#include "qt/quirkturt/settings/settingsnetworkwidget.h"
#include "qt/quirkturt/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/quirkturt/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(quirkturtGUI* _window, QWidget *parent) :
