...
#include "qt/quirkturt/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/quirkturt/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(quirkturtGUI* _window, QWidget *parent) :
