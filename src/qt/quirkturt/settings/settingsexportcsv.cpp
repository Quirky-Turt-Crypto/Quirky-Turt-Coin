...
#include "qt/quirkturt/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(quirkturtGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("quirkturt_tx_csv_export(*.csv)") : tr("quirkturt_addresses_csv_export(*.csv)"),
                                        nullptr);
