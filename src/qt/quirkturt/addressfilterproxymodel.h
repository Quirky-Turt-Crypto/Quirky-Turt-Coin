...
#ifndef quirkturt_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define quirkturt_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //quirkturt_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
