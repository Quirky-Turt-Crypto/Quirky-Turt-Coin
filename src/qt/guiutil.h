...
/** Utility functions used by the quirkturt Qt UI.
 */
namespace GUIUtil
{
...
// Render quirkturt addresses in monospace font
...
// Parse "quirkturt:" URI into recipient object, return true on successful parsing
