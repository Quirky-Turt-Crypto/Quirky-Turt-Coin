...
/** Utility functions used by the quirkyturt Qt UI.
 */
namespace GUIUtil
{
...
// Render quirkyturt addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZqrtc = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZqrtc = false);
...
// Parse "quirkyturt:" URI into recipient object, return true on successful parsing
