...
public:
    ...
    /**
     * Amount of quirkyturt coming in to a transaction
...
// quirkyturt: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
