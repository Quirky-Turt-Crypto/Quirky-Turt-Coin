...
// Copyright (c) 2016-2020 The quirkturt developers
...
public:
    ...
    /**
     * Amount of quirkturt coming in to a transaction
...
// quirkturt: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
