...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("quirkturt Core quirkturt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quirkturt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quirkturt transaction") + "\n" +
                               "  quirkturt-tx [options] -create [commands]   " + _("Create hex-encoded quirkturt transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quirkturt transaction
