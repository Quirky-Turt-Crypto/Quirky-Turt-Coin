...
#define BOOST_TEST_MODULE quirkyturt Test Suite
...
{
        ClearDatadirCache();
        pathTemp = fs::temp_directory_path() / strprintf("test_quirkyturt_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
