...
//
// The Masternode Class. It contains the input of the 10000 QRTC, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 QRTC - checking if valid masternode)
