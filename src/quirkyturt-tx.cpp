...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("quirkyturt Core quirkyturt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quirkyturt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quirkyturt transaction") + "\n" +
                               "  quirkyturt-tx [options] -create [commands]   " + _("Create hex-encoded quirkyturt transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quirkyturt transaction
