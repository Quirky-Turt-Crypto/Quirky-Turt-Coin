Contributing to quirkturt Core
============================

The quirkturt Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/quirkturt-project/quirkturt/blob/master/doc/translation_process.md)
...
The following applies to code changes to the quirkturt Core project, and is not to be
confused with overall quirkturt Network Protocol consensus changes.

Whether a pull request is merged into quirkturt Core rests with the project merge
...
Patches that change quirkturt consensus rules are considerably more involved than
...
Where a patchset proposes to change the quirkturt consensus, it must have been
...
The project leader is the release manager for each quirkturt Core release.
