Contributing to quirkyturt Core
============================

The quirkyturt Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/quirkyturt-project/quirkyturt/blob/master/doc/translation_process.md)
...
The following applies to code changes to the quirkyturt Core project, and is not to be
confused with overall quirkyturt Network Protocol consensus changes.

Whether a pull request is merged into quirkyturt Core rests with the project merge
...
Patches that change quirkyturt consensus rules are considerably more involved than
...
Where a patchset proposes to change the quirkyturt consensus, it must have been
...
The project leader is the release manager for each quirkyturt Core release.
