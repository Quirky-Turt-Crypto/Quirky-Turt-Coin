...
Build quirkyturt Core
------------------------

1. Clone the quirkyturt Core source code:

        git clone https://github.com/quirkyturt-project/quirkyturt
        cd quirkyturt
...
quirkyturt Core is now available at `./src/quirkyturtd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/quirkyturt"

    touch "/Users/${USER}/Library/Application Support/quirkyturt/quirkyturt.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/quirkyturt/quirkyturt.conf"

The first time you run quirkyturtd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/quirkyturt/debug.log

Other commands:
-------

    ./src/quirkyturtd -daemon # Starts the quirkyturt daemon.
    ./src/quirkyturt-cli --help # Outputs a list of command-line options.
    ./src/quirkyturt-cli help # Outputs a list of RPC commands when the daemon is running.
