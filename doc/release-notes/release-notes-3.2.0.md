...
A full report provided by quirkturt developers is available on the [quirkturt Website](https://quirkturt.org/fake-stake-official-quirkturt-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
