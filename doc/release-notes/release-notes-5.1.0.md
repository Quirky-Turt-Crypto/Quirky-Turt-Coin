quirkturt Core version v5.1.0 is now available from:  <https://github.com/quirkturt-project/quirkturt/releases>
...
- #2249 Make box of quirkturt Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better quirkturt.conf Masternode data error notification (furszy)
