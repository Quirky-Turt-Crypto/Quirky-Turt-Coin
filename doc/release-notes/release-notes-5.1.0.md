quirkyturt Core version v5.1.0 is now available from:  <https://github.com/quirkyturt-project/quirkyturt/releases>
...
- #2249 Make box of quirkyturt Send address return to purple when it's empty (PicklesRcool)
...
- #2170 Better quirkyturt.conf Masternode data error notification (furszy)
