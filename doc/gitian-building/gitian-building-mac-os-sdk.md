...
The script [extract-osx-sdk.sh](https://github.com/quirkturt-project/quirkturt/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
quirkturt/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/quirkturt-project/quirkturt/blob/master/doc/README_osx.md) for troubleshooting tips.