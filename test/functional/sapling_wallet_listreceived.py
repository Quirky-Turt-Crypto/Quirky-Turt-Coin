...
class ListReceivedTest (quirkyturtTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 QRTC.
        ...
        # Send 1 QRTC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 QRTC sending them all (fee is 0.1 QRTC)
        ...
        # Confirm transaction (2 QRTC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 QRTC, send 0.6 QRTC + 0.05 QRTC fee
