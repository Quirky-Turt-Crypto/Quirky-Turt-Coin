...
"""Verify that starting quirkyturt with -h works as expected."""
import subprocess

from test_framework.test_framework import quirkyturtTestFramework
from test_framework.util import assert_equal

class HelpTest(quirkyturtTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quirkyturt with -? for help text")
        ...
        self.log.info("Start quirkyturt with -version for version information")
