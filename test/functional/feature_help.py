...
"""Verify that starting quirkturt with -h works as expected."""
import subprocess

from test_framework.test_framework import quirkturtTestFramework
from test_framework.util import assert_equal

class HelpTest(quirkturtTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quirkturt with -? for help text")
        ...
        self.log.info("Start quirkturt with -version for version information")
