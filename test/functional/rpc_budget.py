...
class BudgetProposalTest(quirkturtTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid quirkturt address")
        assert_raises_rpc_error(-5, "Invalid quirkturt address", self.nodes[0].preparebudget,
