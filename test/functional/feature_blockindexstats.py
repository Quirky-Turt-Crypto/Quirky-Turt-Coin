...
class BlockIndexStatsTest(quirkyturtTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 QRTC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 QRTC + 9 notes of 5 QRTC + 1 note of 4 QRTC (using 1.0 fee)
