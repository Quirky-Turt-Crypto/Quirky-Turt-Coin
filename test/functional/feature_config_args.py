...
class ConfArgsTest(quirkyturtTestFramework):
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "quirkyturt.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.quirkyturt)
